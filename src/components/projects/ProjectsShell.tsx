...
const nav = [
  ...
  {
    href: "/projects/my-timesheets",
    label: "Timesheets",
    icon: Clock,
  },
  {
    href: "/projects/my-milestones",
    label: "Milestones",
    icon: BarChart3,
  },
  {
